...
import { ExternalLink, Star, MessageCircle, TrendingUp } from 'lucide-react'
...
export function TrendingBookmarkCard({ bookmark, rank }: TrendingBookmarkCardProps) {
  ...
  const commentCount = bookmark.comments?.length || 0
  ...
  return (
    <div className="group bg-white border border-gray-200 rounded-xl p-4 transition-all duration-200 hover:shadow-lg hover:border-primary-200 hover:-translate-y-1">
      {/* Rank badge */}
